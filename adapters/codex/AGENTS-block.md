# Aegis Method block for AGENTS.md

Append the block below to your repository's `AGENTS.md` (Codex reads it at
session start). Codex then works under the method for every task in the repo.
